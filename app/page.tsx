    ...
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden bg-toss-bg dark:bg-toss-bg">
        <div className="max-w-6xl mx-auto px-6 md:px-10 pt-10 pb-14">
          ...
          {/* 메인 헤드라인 — 한 줄 */}
          <h1 className="text-center text-[26px] md:text-[36px] font-extrabold text-toss-text dark:text-white leading-tight mb-3">
            나의 배당금, <span className="text-toss-blue">얼마나 받을까?</span>
          </h1>
          <p className="text-center text-[15px] md:text-[17px] text-toss-sub dark:text-toss-sub mb-8">
      ...
      <div className="mt-0 bg-toss-blue">
